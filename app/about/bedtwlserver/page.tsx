    ...
    <div className="flex flex-col items-center gap-6 p-6">
      ...
      <Card className="max-w-3xl w-full">
        <CardBody className="flex flex-col items-center text-center gap-2">
          ...
          <ul className="text-left list-disc list-inside">
            ...
            <li><strong>Skill Action:</strong> Kill players, earn skill points, and get the more stornger skill to fight your opponents.</li>
          </ul>
        </CardBody>
      </Card>
      ...
      <Card className="max-w-3xl w-full">
        <CardBody className="flex flex-col items-center text-center gap-2">
          ...
          <ul className="text-left list-disc list-inside">
            ...
            <li><strong>Community Driven:</strong> Build, explore, and thrive with your friend. Or else do it yourself</li>
      ...
      <Card className="max-w-3xl w-full">
        <CardBody className="flex flex-col items-center text-center gap-2">
          ...
          <ul className="text-left list-disc list-inside">
            <li><strong>Jobs System:</strong> Earn coins by working in-game professions.</li>
            <li><strong>Land Protection:</strong> Secure your builds with a land claim system. (It's fucked up now.)</li>
            <li><strong>Armored Elytra:</strong> Soar through the skies with added defense.</li>
            <li><strong>Dynamic Economy:</strong> Trade and grow wealth with in-game currency.</li>
          </ul>
        </CardBody>
      </Card>
